...
namespace LightTest\Db;

use Light\Db\ORM;
use LightTest\Db\TestAsset\MockPDO;
use LightTest\Db\TestAsset\MockPDOOther;
use LightTest\Db\TestAsset\MockPDOMssql;
use LightTest\Db\TestAsset\MockPDOStatement;
use LightTest\Db\TestAsset\MockPDOStatementOther;
...
class CacheTest extends \PHPUnit_Framework_TestCase {
    ...
    public function setUp()
    {
        ...
        ORM::setDb(new MockPDOOther('sqlite::memory:'), self::ALTERNATE);
