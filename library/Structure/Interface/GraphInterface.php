 ...
 */
interface GraphInterface extends ContainerInterface
{
    /**
    ...
    /**
     * Causes a visitor to visit the vertices of this directed graph in depth-first 
     * traversal order starting from a given vertex. This method invokes the PreVisit 
     * and PostVisit methods of the visitor for each vertex in this graph. The traversal 
     * continues as long as the IsDone method of the visitor returns false.
     *
     ...
     */
    public abstract function depthFirstTraversal(PrePostVisitorInterface $visitor, $start);

    /**
     * Causes a visitor to visit the vertices of this directed graph in breadth-first 
     * traversal order starting from a given vertex. This method invokes the Visit 
     * method of the visitor for each vertex in this graph. The traversal continues 
     * as long as the IsDone method of the visitor returns false.
     *
     * @param object VisitorInterface $visitor The visitor to accept.
     * @param integer $start The vertex at which to start the traversal.
     */
    public abstract function breadthFirstTraversal(VisitorInterface $visitor, $start);
}
