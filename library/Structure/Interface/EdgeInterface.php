 ...
 */
interface EdgeInterface extends ComparableInterface
{
    /**
     * Returns one of the two vertices that this edge joins. If this edge is 
     * a directed edge, this method returns the tail of the arc.
     *
    ...
    /**
     * Returns one of the two vertices that this edge joins. If this edge is
     * a directed edge, this method returns the head of the arc.
     *
     * @return object IVertex One of the vertices that this edge joins.
     */
