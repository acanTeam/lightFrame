...
class Util
{
     ...
     * @param  \Light\Http\Headers $headers The Response headers
     * @param  \Light\Http\Cookies $cookies The Response cookies
     * @param  array              $config  The Light app settings
     */
     ...
     *
     * This method will construct and set the HTTP `Set-Cookie` header. Light
     ...
     *
     * This method accepts the Light_Http_Headers object by reference as its
     ...
     * is already set in the HTTP response, it will also be removed. Light uses this method
